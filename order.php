...
$query = "select * from bills where bill_email='" . $_SESSION[ 'customer_email' ] . "'";
$excute = mysqli_query( $conn, $query );
						...
						<table class="table table-bordered tbl-cart">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="#">
											<?php echo $fetch['bill_name']; ?>
										</a>
									</td>
									<td>

										<?php if($fetch['product_id'] == 0) { ?>

											<a href="view_order.php?id=<?php echo $fetch['bill_id']; ?>"> <button class="btn btn-primary btn-lg" style="float: right">View </button></a>


										<?php } else { ?>

											<a href="view_order.php?order=<?php echo $fetch['bill_id']; ?>"> <button class="btn btn-primary btn-lg" style="float: right">View </button></a>
