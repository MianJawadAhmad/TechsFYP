...
if ( isset( $_GET[ 'id' ] ) && $_GET[ 'id' ] != '' ) {
	...
	$excute = mysqli_query( $conn, $query );
		...
		$id = $_GET[ 'order' ];
	$query = "select * from bills INNER JOIN Product on bills.product_id=Product.product_id where bill_id='$id'";
	$excute = mysqli_query( $conn, $query );
...
<body>
	...
	<div class="page-head_agile_info_w3l" style=" background: url(images/ORDER.jpg) no-repeat center;">
		<div class="container">
						...
						<table class="table table-bordered tbl-cart">
							...
							<tbody>
								...
								<tr>
									...
									<td><img src="admin/uploads/<?php echo $record['image'] ?>" width="60" height="50"> </td>
									<td>pesh</td>
                                    
									<td align="right">
										<?php if($record['cart_status'] ==2 )
                                            {
                                                echo '<button class="btn btn-success btn-sm"><i class="fa fa-check" aria-hidden="true"> Confirm </i></button>';
                                            }
                                            else
                                            {
                                                echo '<button class="btn btn-danger btn-sm"><i class="fa fa-times" aria-hidden="true"> Not Confirm </i>
												</button>';
                                            }
