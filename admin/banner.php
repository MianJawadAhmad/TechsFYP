					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <?php $i=1; while($record=mysqli_fetch_array($excute)){ ?>
											<tr>
												...
												<td>
													<?php echo $record['banner_name']; ?>
												</td>
												<td><img src="uploads/<?php echo $record['banner_image']; ?>" height="50" width="50"> </td>
											


													<td class="text-right">
														<a href="edit_banner.php?edit=<?php echo $record['banner_id']; ?>">  <button type="button" rel="tooltip" class="btn btn-info btn-icon btn-sm ">
                            <i class="fa fa-user"></i>
														...
														<a href="process/banner_delete.php?dlt=<?php echo $record['banner_id']; ?>">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<input type="hidden" name="baner" value="form">
					</form>
				</div>
			</div>
		</div>
