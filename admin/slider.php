					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <?php $i=1; while($record=mysqli_fetch_array($excute)){ ?>
											<tr>
												...
												<td>
													<?php echo $record['slider_name'] ?>
												</td>
												<td>
													<?php echo $record['slider_title']; ?>
												</td>
												<td><img src="uploads/<?php echo $record['slider_image']; ?>" height="50" width="50"> </td>
											


													<td class="text-right">
														<a href="edit_slider.php?edit=<?php echo $record['slider_id']; ?>">  <button type="button" rel="tooltip" class="btn btn-info btn-icon btn-sm ">
                            <i class="fa fa-user"></i>
														...
														<a href="process/slider_process.php?dlt=<?php echo $record['slider_id']; ?>">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="process/slider_process.php" method="post" enctype="multipart/form-data">
				...
				<div class="modal-footer">
					...
					<input type="hidden" name="slidr" value="form">
					</form>
				</div>
			</div>
		</div>
