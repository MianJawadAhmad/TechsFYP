					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <?php $i=1; while($record=mysqli_fetch_array($excute)){ ?>
											<tr>
												...
												<td>
													<?php echo $record['addres'] ?>
												</td>
												<td>
													<?php echo $record['email']; ?>
												</td>
                                                <td>
                                                    <?php echo $record['cell_num']; ?>
                                                </td>
												<td>   <?php echo $record['map']; ?></td>
											


													<td class="text-right">
														<a href="edit_contact.php?edit=<?php echo $record['id']; ?>">  <button type="button" rel="tooltip" class="btn btn-info btn-icon btn-sm ">
                            <i class="fa fa-user"></i>
														...
														<a href="process/contact_process.php?dlt=<?php echo $record['id']; ?>">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="process/contact_process.php" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="c_addrs">
						</div>
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Contac-Num :</label>
                            <input type="text" class="form-control" name="c_num">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Map:</label>
                            <input type="text" class="form-control" name="c_map">
                        </div>
				...
				<div class="modal-footer">
					...
					<input type="hidden" name="cntct" value="form">
					</form>
				</div>
			</div>
		</div>
