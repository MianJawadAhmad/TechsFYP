...
$query="select * from offer INNER JOIN Product on offer.product_id=Product.product_id";
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#exampleModal" data-whatever="@mdo">Add Sales</button>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <button class="btn btn-sm btn-danger" onclick="window.location='offer.php?id=<?php echo $record['offer_id'] ?>&status=1'">
                                        Block
                                        </button>
                                            <?php } else{ ?>
                                            <button class="btn btn-sm btn-success" onclick="window.location='offer.php?id=<?php echo $record['offer_id'] ?>&status=0'">
                                                Active
                                            </button>
                                                <?php } ?>
                                            ...
                                            <a href="edit_offer.php?edit=<?php echo $record['offer_id']; ?>">
                                            ...
                                            <a href="process/offer_process.php?dlt=<?php echo $record['offer_id']; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="process/offer_process.php" method="post" enctype="multipart/form-data">
                    ...
                    <option>Select</option>
                        ...
                        <?php echo $product_fetch ['product_name']; ?>
